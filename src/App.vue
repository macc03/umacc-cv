...
const skills = reactive([
  ...
  [{ name: 'JAVASCRIPT', level: '90%' }, { name: 'NODE', level: '80%' }],
  [{ name: 'VUE', level: '90%' }, { name: 'REACT', level: '80%' }],
])
  ...
  <div id="app" @scroll="onPageScroll">
    ...
    <main>
      <section id="about">
        <ContentWrapper>
          <div class="wrap">
            <div>
              <h3>About Me</h3>
              <p>Hello! I am Jin Wang. I am now a PhD student in Soochow University.</p>
              <p>
                I am cheerful, strong sense of responsibility, treat people friendly, good at learning, innovation, work
                clear thinking, the implementation of strong. Through systematic study and the training in the graduate
                student stage, I have been proficient in molecular biology and cell biology techniques. Personal Website
              </p>
            </div>
            <div>
      ...
      <section v-appear="'animate__animated animate__slideInUp'" id="skills">
        <ContentWrapper title="Professional Skills">
      ...
      <section id="experience">
        <ContentWrapper title="Experience">
          <div>
            <h3>About Me</h3>
            <p>
              Hello! I am Jin Wang. I am now a PhD student in Soochow University.
